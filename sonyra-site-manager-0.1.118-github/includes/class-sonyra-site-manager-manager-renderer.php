...
class Sonyra_Site_Manager_Manager_Renderer {
	...
	private static function render_icon( string $name, string $class_name = 'sonyra-manager-icon' ): void {
		if ( 'site-header-footer' === $name ) {
			printf(
				'<svg viewBox="0 0 24 24" class="%1$s" aria-hidden="true" focusable="false" fill="none"><rect x="4" y="5" width="16" height="14" rx="3"></rect><path d="M7 8h10"></path><path d="M7 16h10"></path></svg>',
