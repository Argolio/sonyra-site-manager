...
class Sonyra_Site_Manager_Color_Controller {
	...
	public static function get_manager_payload( string $api_url = '', string $nonce = '' ): array {
		...
		$required_dictionary_keys = array(
			...
			'manager.design.colors.pattern_editor_settings_title',
			'manager.design.colors.pattern_editor_preview_badge',
			'manager.design.colors.pattern_editor_name_label',
			'manager.design.colors.pattern_editor_hint',
			'manager.design.colors.pattern_editor_type_section',
			'manager.design.colors.pattern_editor_dot_settings_section',
			'manager.design.colors.pattern_editor_layers_colors_section',
			'manager.design.colors.pattern_editor_effects_section',
			'manager.design.colors.pattern_type_dots',
			'manager.design.colors.pattern_type_dots_hint',
			'manager.design.colors.pattern_type_grid',
			'manager.design.colors.pattern_type_grid_hint',
			'manager.design.colors.pattern_type_waves',
			'manager.design.colors.pattern_type_waves_hint',
			'manager.design.colors.pattern_type_lines',
			'manager.design.colors.pattern_type_lines_hint',
			'manager.design.colors.pattern_type_paint',
			'manager.design.colors.pattern_type_paint_hint',
			'manager.design.colors.pattern_type_shapes',
			'manager.design.colors.pattern_type_shapes_hint',
			'manager.design.colors.pattern_dot_size',
			'manager.design.colors.pattern_dot_spacing',
			'manager.design.colors.pattern_color_point',
			'manager.design.colors.pattern_layers_count',
			'manager.design.colors.pattern_layer_offset',
			'manager.design.colors.pattern_opacity',
			'manager.design.colors.pattern_random_offset',
			'manager.design.colors.pattern_edge',
			'manager.design.colors.pattern_edge_soft',
			'manager.design.colors.pattern_edge_sharp',
			'manager.design.colors.pattern_back_to_type',
			'manager.design.colors.pattern_name_placeholder',
			'manager.design.colors.create_color',
			'manager.design.colors.create_gradient',
			'manager.design.colors.create_pattern',
		);
